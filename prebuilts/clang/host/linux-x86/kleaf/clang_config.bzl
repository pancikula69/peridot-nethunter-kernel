...
def _impl(ctx):
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        # Use clang_version as the compiler identifier so kernel_platform_toolchain
        # can check that the correct version was resolved (e.g. "r487747c").
        compiler = ctx.attr.clang_version if ctx.attr.clang_version else "__toolchain_compiler__",
